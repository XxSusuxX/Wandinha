...
export class Card {
    ...
    constructor(DOM_el, options) {
        ...
        this.DOM.contentGrid = this.DOM.el.querySelector('.card__content');
        ...
        this.chars = {
            ...
            contentGrid: [...this.DOM.contentGrid.querySelectorAll('.char')],
            link: [...this.DOM.link.querySelectorAll('.char')]
        };

        // Save those initial char values
        [...this.chars.date, ...this.chars.title, ...this.chars.link, ...this.chars.contentGrid].forEach(char => {
    ...
    mouseEnter() {
        ...
        this.shuffleChars(this.chars.contentGrid);
